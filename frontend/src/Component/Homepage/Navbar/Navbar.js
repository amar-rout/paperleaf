                        ...
                        <div className="d-flex flex-0 justify-content-between align-items-center w-100">
                            ...
                            <div className="d-flex justify-content-end align-items-right">
                                ...
                                <div className="d-flex ms-sm-2 justify-content-around align-items-center">
                                    ...
                                    <button className="btn btn-sm position-relative p-1 me-2 me-sm-2 me-md-3 rounded " onClick={() => navigate("/wishlists")}>
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <button className="btn btn-sm position-relative p-1 me-2 me-sm-2 me-md-3 rounded" onClick={() => navigate("/carts")}>
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <>
                                                <div className="dropdown position-relative ms-2 me-2">
                                                    <a href="/" className="d-block link-dark text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                                        <img src={`/assets/${loginUser.image}`} alt={`${loginUser.image}`} width="36" height="36" className="rounded-circle border border-1 border-secondary" style={{ maxWidth: '36px' }} />
                                                    </a>
