            ...
            <div class="container my-5">
                <div className="text-center mb-5">
                    <span class="position-relative">
                        <span className="fs-4 text-dark text-decoration-underline heading">Contact</span>
                                    ...
                                    <div class="col-12 col-md-10 mb-3">
                                        <div class="contact_form_inner">
                                            <div class="contact_field">
                                                ...
                                                <input type="text" class="form-control form-group mb-3" placeholder="Name" />
                                                <input type="text" class="form-control form-group mb-3" placeholder="Email" />
                                                <textarea class="form-control form-group mb-3" placeholder="Message"></textarea>
                                                <button class="contact_form_submit">Send</button>
                                            </div>
                                            <div class="contact_info text-dark d-md-none mt-5">
                                                <h4>Contact Info</h4>
