...
const CategoryItems = ({ paramsValue, urlLink }) => {
    ...
    return (
        <>
            ...
            />
            <div className="container-fluid container-md my-3 bg-body">
                ...
                {products.length === 0 ?
                    ...
                    <div className="row row-cols-2 row-cols-sm-2 row-cols-md-4 row-cols-lg-6 g-1 g-sm-2 g-md-4 g-lg-2">
                        {products.map((product) => (
                            <div key={product._id} className="col">
                                <div className="card product_card bg-light p-0 p-md-0 m-0 shadow-sm rounded-0 border border-0">
