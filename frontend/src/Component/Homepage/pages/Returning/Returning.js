        ...
        <>
            ...
            <Breadcrumb
                links={[
                    ...
                    { name: 'Returning', link: '/returning', active: true }
                ]}
            />
            <div className="container mb-5">
                <div className="my-5 text-center">
                    <span class="position-relative">
                        <span className="fs-2 text-dark text-decoration-underline heading">Return Policy</span>
                ...
                <div className="row">
                    <div className="col-12">
                        <div className="my-3 my-md5 text-justified">
                            <p className="fs-6 fw-semibold mb-3">Returns & Exchanges Policy :</p>
                            <p>
                                Any Clothing Items Like Dupatta, Stole, Dress Materials, Semi-Stitched Materials Are Eligible For Returns & Exchange. However, Fabrics And Pre-Cut Fabrics, Customised Products & Products Bought On Sale Are Not Eligible For Return Or Exchange.
                            </p>
                            <p>
                                To Be Eligible For A Return, Your Item Must Be In The Same Condition That You Received It, Unworn & Unused, With Tags, And In Its Original Packaging. You'll Also Need The Receipt Or Proof Of Purchase (Bill/ Invoice).
                            </p>
                            <p>
                                To Start A Return, You Can Mail Us At <a className="fs-6" href="Mailto:contact@paperleaf.co.in">contact@paperleaf.co.in</a> . The Request To Return Or Exchange Has To Be Placed Within 3 Days From The Date Of Receipt Of Shipment. We'll Send You Return Shipping Instructions On How And Where To Send Your Package - Reverse Pick Up Is Not Available, Which Means You Will Have To Send The Package Back To Us On Your Own, Though We Will Share All Details Required To Ship It To Us. Items Sent Back To Us Without Requesting A Return Will Not Be Accepted.
                            </p>
                            <p>
                                We Will Notify You Once We Have Received And Inspected Your Return, Then Will Issue Store Credit To You, Which Will Be Amount Of The Value Of Your Return Order Excluding Any Shipping Cost Paid By You At The Time Of Placing An Order.
                            </p>
                            <p>
                            ...
                            <p>
                                You Can Always Contact Us For Questions Regarding Your Purchase
                                At <a className="fs-6" href="Mailto:paperleaf.brand@gmail.com">paperleaf.brand@gmail.com</a>
                            </p>
                        </div>
                    </div>
                </div>
