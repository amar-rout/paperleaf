...
const Register = () => {
    ...
    // }
    const register = () => {
        const { fname, lname, email, phone, password, reEnterPassword } = user
                ...
                <div className="row">
                    ...
                    <div className="col-10 col-md-8 col-lg-4">
                        ...
                        <input className="form-control form-control-lg border-1 border-secondary py-3 px-4 fs-6 rounded-3 mb-3 text-decoration-none shadow-none"
                            type="text" isValid name="fname" value={user.fname} onChange={handleChange} placeholder="Ener your first name"
                        />

                        <label className="form-label">Last name *</label>
                        <input className="form-control form-control-lg border-1 border-secondary py-3 px-4 fs-6 rounded-3 mb-3 text-decoration-none shadow-none"
                            type="text" isValid name="lname" value={user.lname} onChange={handleChange} placeholder="Enter your last name"
                        />
                        ...
                        <div class="btn-group w-100 opacity-1 mb-3" role="group" aria-label="Basic radio toggle button group">
                            ...
                            <label class="btn btn-outline-dark py-3" for="btnradio1">Male</label>
                            ...
                            <label class="btn btn-outline-dark py-3" for="btnradio2">Female</label>
                            ...
                            <label class="btn btn-outline-dark  py-3" for="btnradio3">Others</label>
                        </div>
