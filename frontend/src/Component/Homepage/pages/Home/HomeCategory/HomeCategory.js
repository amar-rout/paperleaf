            ...
            <div className="container">
                ...
                <div className="text-center d-flex justify-content-center row row-cols-2 row-cols-sm-3 row-cols-md-3 row-cols-lg-4 g-2 g-sm-2 g-md-3 g-lg-4">
                    <button className="col btn btn-default cat-btn" onClick={() => navigate('/category/kurtis')}>
                        <img src= "/assets/images/categoryImages/kurti.jpg" className="category-img bd-placeholder-img rounded-circle border " alt="" />
                    ...
                    <button className="col btn btn-default cat-btn" onClick={() => navigate('/category/dupattas')}>
                        <img src="/assets/images/catImages/dupattas.jpg" className="category-img bd-placeholder-img rounded-circle border " alt="" />
                    ...
                    <button className="col btn btn-default cat-btn" onClick={() => navigate('/category/dress')}>
                        <img src="/assets/images/catImages/dress.jpg" className="category-img bd-placeholder-img rounded-circle border " alt="" />
                    ...
                    <button className="col btn btn-default cat-btn" onClick={() => navigate('/category/fabrics')}>
                        <img src="/assets/images/catImages/fabrics.jpg" className="category-img bd-placeholder-img rounded-circle border " alt="" />
                        <h6 className="fw-normal pt-2 category-text">Fabrics</h6>
                    </button>
                    <button className="col btn btn-default cat-btn" onClick={() => navigate('/category/dress')}>
                        <img src="/assets/images/catImages/pants.jpg" className="category-img bd-placeholder-img rounded-circle border " alt="" />
                    ...
                    <button className="col btn btn-default cat-btn" onClick={() => navigate('/category/jewellery')}>
                        ...
                        <img src="/assets/images/catImages/jewellery.jpg" className="category-img bd-placeholder-img rounded-circle border " alt="" />
                    ...
                    <button className="col btn btn-default cat-btn opacity-1" onClick={() => navigate('/category/others')}>
                        <img src="/assets/images/catImages/others.jpg" className="category-img bd-placeholder-img rounded-circle border " alt="" />
