            ...
            <div className="container mb-5">
                ...
                <div className="my-5 text-center">
                    <span class="position-relative">
                        <span className="fs-2 text-dark text-decoration-underline">Shipping Policy</span>
                ...
                <div className="row">
                    <div className="col-12">
                        <p>
                            Welcome to <strong>paperleaf.co.in</strong> By Placing An Order Through This Website, You Will Be Agreeing To The Terms & Condition Below. These Are Provided To Ensure Both Parties Are Aware Of And Agree Upon These Arrangements To Mutually Protect & Set Expectation On Our Service.
                        </p>
                        <p>
                            Once You Place Your Orders, We Aim To Ship The Products Within 48 Hours. I.E. Two Working Days From The Date Of Order Confirmation. In Case Of Any Delay In Dispatching The Products, We Will Keep You Updated Via Email. However, Made To Order Products Might Take 7 To 10 Days To Dispatch.
                        </p>
                        <p>
                            Kindly Note That The Delivery Times Mentioned Are Indicative Only. In Case Be Delayed Due To Factors Beyond Our Control Including Delay From Our Courier Partners / Transporters Or Due To Weather Conditions & Strikes.
                        </p>
                        <p>
                            However, Taking Into Consideration & To Ensure Your Products Reaches You In A Good Condition In The Designated Time Period We Ship Through Reputed Courier Agencies Only.
                        </p>
                        <p>
                            Paper Leaf (Provides Free Shipping On All Orders Above ₹ 2000. For Orders Below The Mentioned Amount, The Shipping Cost Are Calculated During Checkout Based On Weight & Destination Of The Items In The Order Payment For Shipping Will Be Collected With The Purchase.
                        </p>
                        <div className="row">
                            <div className="col-12 col-md-4"></div>
                            <div className="col-12 col-md-4"></div>
                            <div className="col-12 col-md-4">
                                <p className="pb-0 mb-0 lh-1">
                                    Thank You For Putting Your Trust In It.
                                </p>
                                <p className="fw-normal lh-1 mt-3">Paper Leaf Team</p>
                            </div>
                        </div>
