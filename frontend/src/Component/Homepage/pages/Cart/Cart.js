...
import { getCartListStatus, getCartListError, getListCartItems, getCartCount } from "../../../../app/cartSlice";
...
const Cart = () => {
    ...
    const getCartStatus = useSelector(getCartListStatus);
    const getCartCounts = useSelector(getCartCount);
    const getCartError = useSelector(getCartListError);
    ...
    }, [getCartStatus, getCartItems, getCartError]);
        ...
        <HelmetProvider>
            ...
            <Breadcrumb
                links={[
                    ...
                    { name: 'Cart', link: '/carts', active: true },
                ]}
            />
