            ...
            <div className="container text-start">
                <div className="my-5 text-center">
                    <span class="position-relative">
                        <span className="fs-2 text-dark text-decoration-underline heading">About</span>
                ...
                <div className="row mb-5">
                    ...
                    <div className="col-12">
                        ...
                        <p>
                            The brand ‘Paper Leaf' work with artist and weavers to create some unique & exquisite designs to celebrate ethical & sustainable fashion. We aim for supporting Indian artisans & craftmanship.
                        </p>
                        <p>
                            The speciality of our brand is the vibrant colours & texture of the fabrics along with the range of exquisite weaves, embroideries, and versatility. They can be worn for work, for special occasion or for your daily style statement. You just need to pick up the night one for a specific need.
                        </p>
                        <p className="lh-2 text-end">
                            Thank You For Considering Us <br/>
                            Hope We Make You Feel Special <br/>
                           <strong>-Paper Leaf Team-</strong>
                        </p>
                    </div>
                </div>
            </div>
