    ...
    return (
        <>
            ...
            <div className="container my-5">
                <h4 className="mb-5 text-decoration-underline text-center">Login</h4>
                <div className="row my-4">
                    ...
                    <div className="col-10 col-md-8 col-lg-4">
                        ...
                        <input class="form-control form-control-lg border-1 border-secondary rounded rounded-3 mb-3 fs-6 text-decoration-none shadow-none"
                        ...
                        <div class="input-group input-group-merge border border-0 mb-3">
                            <input className="form-control form-control-lg border-1 border-secondary fs-6 text-decoration-none shadow-none" name="password"
                                ...
                                autocomplete="off" />
                            <button type="button" class="btn btn-sm border-1 border-secondary input-group-text px-3" onClick={togglePassword}>
                                {passwordShown ?
                        ...
                        <button className="btn btn-md btn-default btn-warning w-100 my-2 py-2 rounded rounded-3 fw-semibold" type="button" onClick={login}>Login</button>
                        <div className="text-success text-center">
                            {successMessage}
                        </div>
                        <div className="text-start start-0 m-0 mt-3 p-0">
                            Don't have an account yet?
                            <Link to="/register" className="px-1 fw-bold fs-small" type="button">Sign up</Link>
                        </div>
                    </div>
                    <div className="col-1 col-md-2 col-lg-4"></div>
                </div>
